"""Rebuilds Figure 2 (RAG pipeline diagram) with the corrected PDF/CSV counts."""
import matplotlib
matplotlib.use("Agg")
...
OUT = "docs/manuscript_revision/Figure2_pipeline_diagram.png"
...
ax.text(7.5, 6.6, "Figure 2: Retrieval-Augmented Generation (RAG) Pipeline", fontsize=12.5,
